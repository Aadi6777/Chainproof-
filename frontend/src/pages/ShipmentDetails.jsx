...
import { fetchShipmentDetails } from '../api/api';
  ...
  return (
    <div className="animate-fade-in" style={{ maxWidth: '900px', margin: '0 auto', paddingBottom: '100px' }}>
      ...
      <div style={{ position: 'relative', paddingLeft: '32px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px', fontSize: '0.75rem', fontWeight: '700', color: h.managerApproved ? 'var(--color-green)' : 'var(--text-muted)' }}>
                    <ShieldCheck size={14} /> Manager {h.managerApproved ? 'OK' : '...'}
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px', fontSize: '0.75rem', fontWeight: '700', color: h.consumerApproved ? 'var(--color-green)' : 'var(--text-muted)' }}>
                    <CheckCircle size={14} /> Consumer {h.consumerApproved ? 'OK' : '...'}
                  </div>
                </div>
              </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', color: 'var(--text-muted)', fontSize: '0.9rem', paddingLeft: '8px' }}>
          <Clock size={16} />
